...
// import AtmosphereModal from '../../Modal/AtmosphereModal/AtmosphereModal.jsx'; // Імпортуємо сюди
// import {
//   validateName,
//   validateEmail,
//   validatePhone,
...
//   const [previewZone, setPreviewZone] = useState(null); // Стан модалки тепер тут
...
//       {/* Передаємо функцію відкриття модалки вниз */}
//       <AtmosphereSelector
//         selectedZone={formData.selectedZone}
//         onSelectClick={zone => setPreviewZone(zone)}
//       />
...
//       {/* МОДАЛКА ТЕПЕР ТУТ — вона перекриє всю форму */}
//       {previewZone && (
//         <AtmosphereModal
//           isOpen={!!previewZone}
...
const FormBooking = () => {
  // Додаємо keyPrefix, щоб не дублювати 'form_booking' у кожному t()
  ...
  const onSubmit = async currentFormData => {
    // Звертаємось до вкладеного об'єкта atmosphere
    const translatedZone = currentFormData.selectedZone
      ? t(`atmosphere.zones.${currentFormData.selectedZone}`).replace(
          '<br />',
          ' '
        )
      : t('atmosphere.not_selected');
