...
//     // Формуємо об'єкт так, щоб він зберігся в базі як об'єкт з мовами
//     const newReview = {
//       name: {
//         uk: formData.name_uk,
//         en: formData.name_uk, // копіюємо для англійської
//       },
//       text: {
//         uk: formData.text_uk,
//         en: formData.text_uk, // копіюємо для англійської
//       },
...
//     try {
//       console.log('На сервер відправляємо:', newReview);

//       // Тут ваш запит до API, наприклад:
//       // await addReviewToDatabase(newReview);
