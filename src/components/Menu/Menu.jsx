...
//         {/* Навігація фільтрів (з'являється разом з даними або видима одразу) */}
//         {!loading && (
...
//             ))
//           ) : (
//             /* Повідомлення, якщо меню порожнє */
