...
//               <Button
//                 // Додаємо клас fixed-width сюди
//                 className={`${css['google-button']} ${css['fixed-width']}`}
...
//               <Button
//                 // І сюди також
//                 className={`${css['google-button']} ${css['collapse-btn-fix']} ${css['fixed-width']}`}
//                 onClick={() => {
//                   setVisibleCount(3);
//                   document
//                     .getElementById('reviews')
//                     .querySelector('h2') // Краще скролити до заголовка, щоб не "перестрибнути" секцію
